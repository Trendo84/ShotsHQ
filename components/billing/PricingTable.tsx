...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    price: "$19",
    cadence: "one-off",
    description: "100 credits, roughly 50 sets. Never expires.",
    cta: "Buy pack",
  ...
  },
  {
    ...
    price: "$49",
    cadence: "one-off",
    description: "300 credits. Best value for serial launchers.",
    flag: "Best value",
    cta: "Buy pack",
  ...
  },
  {
    ...
    price: "$29",
    cadence: "per month",
    description: "Unmetered AI, public API. Annual: $19/mo equivalent.",
    highlight: true,
    cta: "Subscribe",
