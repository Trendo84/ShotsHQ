...
export const SURFACES: Surface[] = [
  ...
  /* ─────────────  Community  ───────────── */
  {
    ...
    category: "community",
    description: "Eight-tile gallery + thumbnail + topic icon — hunt-day ready.",
    minPlan: "indie",
    previewAspect: "127 / 76",
    variants: [
      { id: "1270x760",   name: "Gallery tile (×8)",  width: 1270, height: 760, required: true },
      { id: "240x240",    name: "Topic icon",         width: 240,  height: 240, required: true },
      { id: "1024x500",   name: "Featured banner",    width: 1024, height: 500 },
    ],
    status: "beta",
    tagline: "Hunt-day ready.",
    rationale: "Exact dimensions Product Hunt requires. We render the 8-tile gallery, thumbnail, topic icon — all from the same project.",
  },
  {
    id: "github-social",
